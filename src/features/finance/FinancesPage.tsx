...
import { Info, Target, Plus, Minus, ChevronUp, Calculator, RotateCcw, Sparkles } from 'lucide-react';
...
import { MonthSpreadsheet } from './MonthSpreadsheet';
            ...
            <div className="w-full max-w-[1600px] mx-auto p-4 md:p-8 relative z-10 space-y-8">
                ...
                <div className="hidden md:block space-y-6">
                    ...
                    <MetricCardsRow
                        ...
                        currentBalanceDisplay={config.actualBalanceDisplay ?? config.initialBalance}
                        saveCurrentBalance={saveCurrentBalance}
