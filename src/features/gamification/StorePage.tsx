                ...
                {history.length > 0 && (
                    <section>
                        ...
                        <div className="space-y-2 max-w-2xl">
                            {(showAllHistory ? history : history.slice(0, 8)).map((tx) => (
                                <div
                                    key={tx.id}
                        ...
                        {history.length > 8 && (
                            <button
                                ...
                                className="flex items-center gap-1.5 mt-4 text-xs text-neutral-600 hover:text-neutral-400 transition-colors font-medium"
                            >
                                {showAllHistory ? 'Ver menos' : 'Ver todo el historial'} <ArrowUpRight size={12} />
                            </button>
                        )}
                    </section>
                )}
